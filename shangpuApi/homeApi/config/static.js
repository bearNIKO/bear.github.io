...
module.exports = function(router, options) {
    ...
    router.all(/((\.jpg)|(\.png)|(\.gif))$/i, static(path.join(__dirname,'../public'), {
        maxage: options.image * 86400 * 1000
    }));
    router.all(/((\.js)|(\.jsx))$/i, static(path.join(__dirname,'../public'), {
        maxage: options.script * 86400 * 1000
    }));
    router.all(/(\.css)$/i, static('./static', {
        maxage: options.styles * 86400 * 1000
    }));
    router.all(/((\.html)|(\.htm))$/i, static(path.join(__dirname,'../public'), {
